      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/80 backdrop-blur-md">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6">
            <a href="#" className="text-sm font-medium hover:text-primary transition-colors">Funcionalidades</a>
            <a href="#" className="text-sm font-medium hover:text-primary transition-colors">Modelos</a>
            <a href="#" className="text-sm font-medium hover:text-primary transition-colors">Preços</a>
          </nav>
          <div className="flex items-center gap-4">
            <button className="text-sm font-semibold text-primary hover:underline">Entrar</button>
      ...
      <section className="py-12 md:py-20 bg-gradient-to-b from-primary/5 to-transparent">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-4xl">
          <div className="inline-flex items-center gap-2 bg-accent/10 border border-accent/20 px-4 py-1.5 rounded-full text-accent font-bold text-xs uppercase tracking-wider mb-6 animate-fade-in">
            ...
            Novo: Integração com Gemini 1.5 Flash
          </div>
          <h1 className="text-4xl md:text-6xl font-black text-slate-900 tracking-tight leading-tight mb-6">
            Gere Páginas de Pré-venda <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent">
              de Alta Conversão em Segundos
            </span>
          </h1>
          <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-2xl mx-auto leading-relaxed">
            Pare de perder tráfego qualificado. Nossa IA cria headlines e copies persuasivas que aquecem seu público antes de chegarem à oferta principal.
          </p>
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm font-semibold text-slate-500 max-w-2xl mx-auto">
            <div className="flex items-center justify-center gap-2">
              <ShieldCheck className="h-4 w-4 text-primary" /> Foco em SEO
            </div>
            <div className="flex items-center justify-center gap-2">
              <Layout className="h-4 w-4 text-primary" /> HTML Limpo
            </div>
            <div className="flex items-center justify-center gap-2 hidden md:flex">
              <Layers className="h-4 w-4 text-primary" /> Design Responsivo
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="mt-auto border-t bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-slate-500 max-w-sm leading-relaxed mb-6">
                Capacitando afiliados e empreendedores digitais a maximizarem suas conversões com tecnologia de ponta e copywriting estratégico.
              </p>
              <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <ul className="space-y-4 text-slate-500 text-sm">
                <li><a href="#" className="hover:text-primary">Copywriter IA</a></li>
                <li><a href="#" className="hover:text-primary">Modelos de Presell</a></li>
                <li><a href="#" className="hover:text-primary">Exportação HTML</a></li>
                <li><a href="#" className="hover:text-primary">Guia de Integração</a></li>
              </ul>
            </div>
            <div>
          ...
          <div className="mt-12 pt-8 border-t text-center text-sm text-slate-400">
            <p>&copy; {new Date().getFullYear()} Presell Genius. Criado para quem busca escala.</p>
          </div>
        </div>
      </footer>
    </div>
